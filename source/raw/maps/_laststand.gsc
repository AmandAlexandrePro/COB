...
laststand_take_player_weapons(solo)
{
	...
	for( i = 0; i < self.weaponInventory.size; i++ )
	{
		...
		if( solo && ( ( !self hasWeapon("ray_gun") && !self hasWeapon("ray_gun_upgraded") ) || ( self GetAmmoCount("ray_gun") == 0 || self GetAmmoCount("ray_gun_upgraded") == 0 ) ) )
		{
		...
		if( self hasWeapon("ray_gun_upgraded") && self GetAmmoCount("ray_gun_upgraded") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "ray_gun_upgraded";
		}
		else if( self hasWeapon("ray_gun") && self GetAmmoCount("ray_gun") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "ray_gun";
		}
		else if( self hasWeapon("zombie_sw_357_upgraded") && self GetAmmoCount("zombie_sw_357_upgraded") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "zombie_sw_357_upgraded";
		}
		else if( self hasWeapon("zombie_sw_357") && self GetAmmoCount("zombie_sw_357") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "zombie_sw_357";
		}
		else if( self hasWeapon("zombie_colt_upgraded") && self GetAmmoCount("zombie_colt_upgraded") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "zombie_colt_upgraded";
		}
		else if( self hasWeapon("zombie_tokarev_upgraded") && self GetAmmoCount("zombie_tokarev_upgraded") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "zombie_tokarev_upgraded";
		}
		else if( self hasWeapon("zombie_nambu_upgraded") && self GetAmmoCount("zombie_nambu_upgraded") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "zombie_nambu_upgraded";
		}
		else if( self hasWeapon("zombie_walther_upgraded") && self GetAmmoCount("zombie_walther_upgraded") != 0 && !IsDefined( self.laststandpistol ) ) 
		{
			self.laststandpistol = "zombie_walther_upgraded";
		}
...
laststand_giveback_player_weapons()
{
	...
	else if( self HasWeapon("m1garand_gl_zombie_upgraded") ) // for pap
	{
		self setactionslot(3,"altMode","m7_launcher_zombie_upgraded");
		self SetWeaponAmmoStock( "m1garand_gl_zombie_upgraded", self.weaponAmmo["m1garand_gl_zombie_upgraded"]["stock"] ); 
	}
...
laststand_give_pistol()
{
	...
	if( IsDefined( self.laststandpistol ) )
	{
		...
		if (self.laststandpistol == "ray_gun" || self.laststandpistol == "ray_gun_upgraded")
		{
...
revive_trigger_think()
{
	...
	while( 1 )
	{
		...
		for( i = 0; i < players.size; i++ )
		{
			...
			else if ( !reviver is_reviving( self ) )
				continue;
