...
init_loadout()
{
	...
	for ( i = 0; i < players.size; i++ )
	{
		...
		players[i] thread give_loadout(true);
	}
...
init_models_and_variables_loadout()
{
	...
	else
	{
		...
		PrecacheItem( "zombie_tokarev" );
		PrecacheItem( "zombie_nambu" );
		PrecacheItem( "zombie_walther" );
		...
		set_player_specific_viewmodel(0, "viewmodel_arms_dempsey");   //Dempsey
        set_player_specific_viewmodel(1, "viewmodel_arms_nikolai");   //Nikolai
        set_player_specific_viewmodel(2, "viewmodel_arms_takeo");     //Takeo
        set_player_specific_viewmodel(3, "viewmodel_arms_richtofen"); //Richtofen
...
give_loadout(wait_for_switch_weapon)
{
	...
	while( !IsDefined( self.player_switchweapon ) )
	{}
	...
	self GiveWeapon( self.player_switchweapon );
